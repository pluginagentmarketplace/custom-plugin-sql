...
This guide provides comprehensive documentation for the **migrations** skill in the custom-plugin-sql plugin.
...
```bash
# Invoke the skill
claude "migrations - [your task description]"

# Example
claude "migrations - analyze the current implementation"
```
...
def implement_migrations(input_data):
    """
    Implement migrations functionality.
