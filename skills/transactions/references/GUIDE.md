...
This guide provides comprehensive documentation for the **transactions** skill in the custom-plugin-sql plugin.
...
```bash
# Invoke the skill
claude "transactions - [your task description]"

# Example
claude "transactions - analyze the current implementation"
```
...
def implement_transactions(input_data):
    """
    Implement transactions functionality.
