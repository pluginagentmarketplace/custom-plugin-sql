...
This guide provides comprehensive documentation for the **security** skill in the custom-plugin-sql plugin.
...
```bash
# Invoke the skill
claude "security - [your task description]"

# Example
claude "security - analyze the current implementation"
```
...
def implement_security(input_data):
    """
