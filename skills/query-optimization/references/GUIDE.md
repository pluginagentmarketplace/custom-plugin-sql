...
This guide provides comprehensive documentation for the **query-optimization** skill in the custom-plugin-sql plugin.
...
```bash
# Invoke the skill
claude "query-optimization - [your task description]"

# Example
claude "query-optimization - analyze the current implementation"
```
...
def implement_query_optimization(input_data):
    """
    Implement query-optimization functionality.
