...
**Your Level:**
- [ ] Beginner (1-2 correct)
- [ ] Intermediate (3-4 correct)
- [ ] Advanced (5-6 correct)
...
**Your Level:**
- [ ] Beginner (learning BI)
- [ ] Intermediate (some dashboards)
- [ ] Advanced (strategic BI)
...
- If SQL < 50%: `/browse-agent sql-fundamentals`
- If Database Admin < 50%: `/browse-agent postgresql-dba`

**Priority 2 (Next Steps):**
- If Data Analysis < 50%: `/browse-agent data-analyst`
- If BI < 50%: `/browse-agent bi-analyst`

**Priority 3 (Advanced):**
- If Data Engineering < 50%: `/browse-agent data-engineer`
...
1. **Be honest** about your actual skills
2. **Focus on hands-on** experience, not theory
3. **Consider production** use, not just learning projects
4. **Update periodically** as you progress
...
1. **Take Assessment**: Answer questions above
2. **Review Results**: See your skill profile
3. **Choose Agent**: Start with recommended path
4. **Work Through Skills**: Study each skill document
5. **Try Projects**: `/projects` for hands-on practice
