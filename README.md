...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=2E9EF7&center=true&vCenter=true&multiline=true&repeat=true&width=600&height=100&lines=Sql+Assistant;8+Agents+%7C+17+Skills;Claude+Code+Plugin" alt="Sql Assistant" />
...
> **Sql Assistant** is a Claude Code plugin with **8 agents** and **17 skills** for sql development.
...
| Feature | Description |
|---------|-------------|
| 🤖 **8 Agents** | Specialized AI agents for sql tasks |
